        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div class="flex mt-3 space-x-2 md:mt-0">
            ...
            <button 
              ...
              class="btn px-3 py-1 text-sm bg-transparent text-[rgb(var(--color-error))] hover:bg-[rgb(var(--color-error)/0.1)]"
            >
              削除
            </button>
          </div>
      ...
      <div v-if="totalPages > 1" class="flex justify-center mt-6">
        <div class="flex space-x-2">
          <button 
            ...
            class="btn px-3 py-1 text-sm bg-transparent text-[rgb(var(--color-primary))] hover:bg-[rgb(var(--color-primary)/0.1)]"
          ...
          <button 
            ...
            :class="page === currentPage ? 'bg-[rgb(var(--color-primary))] text-[rgb(var(--color-text-white))]' : 'bg-transparent text-[rgb(var(--color-primary))] hover:bg-[rgb(var(--color-primary)/0.1)]'"
          >
            {{ page }}
          </button>
          <button 
