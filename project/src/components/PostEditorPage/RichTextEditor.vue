<template>
  <div class="rich-text-editor">
    <!-- エディターメニュー -->
    <div class="editor-menu glass-card p-2 mb-2 flex flex-wrap gap-1">
      <!-- 見出し -->
      <button
    ...
    <!-- エディター本体 -->
    <div 
      class="editor-content glass-card p-4"
    ...
    <div 
      v-if="showLinkMenu" 
      class="link-menu glass-card p-3 absolute z-20 shadow-lg rounded"
    ...
    >
      ...
      <div class="flex justify-end space-x-2">
        <button 
          ...
          class="px-2 py-1 text-xs rounded bg-surface-accent hover:bg-surface-variant"
        >
          キャンセル
        </button>
        <button 
        ...
        <button 
          @click="applyLink"
          class="px-2 py-1 text-xs rounded bg-primary-light text-white hover:bg-primary"
          :disabled="!linkUrl"
        >
          適用
        </button>
...
<style lang="postcss">
.menu-button {
  @apply p-1.5 rounded hover:bg-surface-accent text-text-muted;
}
