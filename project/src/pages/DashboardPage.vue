  ...
  <div class="max-w-4xl mx-auto py-8">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="md:col-span-1">
        <div class="glass-card p-4 sticky top-24 shadow-[0_8px_15px_rgb(var(--color-background)/0.5)]">
          ...
          <nav class="space-y-2">
            <button 
              ...
              :class="activeTab === 'posts' 
                ...
                : 'hover:bg-[rgb(var(--color-surface-accent))]'"
            >
            ...
            <button 
              ...
              class="w-full text-left px-4 py-2 rounded transition-colors"
              :class="activeTab === 'drafts' ? 'bg-[rgb(var(--color-primary)/0.2)] text-[rgb(var(--color-primary))]' : 'hover:bg-[rgb(var(--color-surface-accent))]'"
            >
              <div class="flex items-center">
                <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button 
              ...
              class="w-full text-left px-4 py-2 rounded transition-colors"
              :class="activeTab === 'comments' ? 'bg-[rgb(var(--color-primary)/0.2)] text-[rgb(var(--color-primary))]' : 'hover:bg-[rgb(var(--color-surface-accent))]'"
            >
              <div class="flex items-center">
                <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button 
              ...
              class="w-full text-left px-4 py-2 rounded transition-colors"
              :class="activeTab === 'likes' ? 'bg-[rgb(var(--color-primary)/0.2)] text-[rgb(var(--color-primary))]' : 'hover:bg-[rgb(var(--color-surface-accent))]'"
            >
              <div class="flex items-center">
                <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button 
              ...
              class="w-full text-left px-4 py-2 rounded transition-colors"
              :class="activeTab === 'stats' ? 'bg-[rgb(var(--color-primary)/0.2)] text-[rgb(var(--color-primary))]' : 'hover:bg-[rgb(var(--color-surface-accent))]'"
            >
              <div class="flex items-center">
                <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
