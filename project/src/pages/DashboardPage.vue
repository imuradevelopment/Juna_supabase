        ...
        <div class="glass-card p-4 sticky top-24">
          ...
          <nav class="space-y-2">
            <button 
              ...
              :class="activeTab === 'posts' ? 'bg-primary/20 text-primary' : 'hover:bg-surface-accent'"
            >
            ...
            <button 
              ...
              class="w-full text-left px-4 py-2 rounded transition-colors"
              :class="activeTab === 'drafts' ? 'bg-primary/20 text-primary' : 'hover:bg-surface-accent'"
            >
              <div class="flex items-center">
                <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button 
              ...
              class="w-full text-left px-4 py-2 rounded transition-colors"
              :class="activeTab === 'comments' ? 'bg-primary/20 text-primary' : 'hover:bg-surface-accent'"
            >
              <div class="flex items-center">
                <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button 
              ...
              class="w-full text-left px-4 py-2 rounded transition-colors"
              :class="activeTab === 'likes' ? 'bg-primary/20 text-primary' : 'hover:bg-surface-accent'"
            >
              <div class="flex items-center">
                <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button 
              ...
              class="w-full text-left px-4 py-2 rounded transition-colors"
              :class="activeTab === 'stats' ? 'bg-primary/20 text-primary' : 'hover:bg-surface-accent'"
            >
              <div class="flex items-center">
                <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
